...
const DECLARATION_SPECS = [
  ...
  { listKey: 'added_gameversion_stats', table: 'gameversion_stats', idCol: 'gvstatuuid', db: 'rhdata.db' },
  ...
  { listKey: 'added_extrapatches', table: 'extrapatches', idCol: 'epuuid', db: 'rhdata.db' },
