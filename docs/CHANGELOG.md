...
- Added `jstools/newgame.js`, an interactive authoring assistant that builds JSON skeletons, validates inputs, and upserts/removes gameversion + attachment records for new submissions (documented in `docs/PROGRAMS.MD`).
