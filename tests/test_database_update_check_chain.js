...
const manifest = {
  ...
  'patchbin.db': {
    version: '14',
    'version:light': '3',
    base: { file_name: 'full.tar.xz' },
    'base:light': { file_name: 'light.xz' },
    sqlpatches: [{ file_name: 'pbin13_to_14.sql.xz', version_before: '13' }],
    'sqlpatches:light': [{ file_name: 'pbinL2_to_3.sql.xz', version_before: '2' }]
  },
  'rhdata.db': { version: '14', base: {}, sqlpatches: [] },
  'resource.db': { version: '14', base: {}, sqlpatches: [] },
  'screenshot.db': { version: '14', base: {}, sqlpatches: [] }
};
