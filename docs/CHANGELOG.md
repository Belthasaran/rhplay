- **Quick launch auto-launch/auto-next**: Launch Preference (Auto/Manual) replaces USB2SNES Launch Preference; Auto-Next setting; Games Staged modal game info/nav/toggles; shared launch session monitor; `cur_booted.json`/`cur_booted.html`; Active Run exit Win/Skip modal.
