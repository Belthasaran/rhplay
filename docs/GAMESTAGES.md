...
requisites,playable,rando,difficulty,mainexit,keyhole,credits,ghouse,spalace,castle,water,boss,secret,troll,final,lock,playlevel_patch_code,excluded_patchcodes,rhpakuuid,extradescription
