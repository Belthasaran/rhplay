...
writer.writerow(['json','filecode','sfc_rom_sha1_hash','sfc_rom_sha256_hash','gameid','name','gamedate','author','authors','index7z_name','indexbps_name','bps_sha1_hash','bps_sha256_hash'])
...
for de in os.listdir("."):
    ...
    if m:
         ...
         bps_sha256_hash = ''
         bps_sha1_hash = ''
         if 'bps_sha1_hash' in j:
             bps_sha1_hash = j['bps_sha1_hash']
         if 'bps_sha256_hash' in j:
             bps_sha256_hash = j['bps_sha256_hash']
         ...
         writer.writerow([de,hashcode,sfc_rom_sha1_hash,sfc_rom_sha256_hash,gameid,name,gamedate,author,authors,index7z_name,indexbps_name])
