...
- **gameversions27zfolder.js**: Retrospective catalog backfill from `gameversions` DB rows using local ZIP search (`--sourcezips-folder`) with download fallback; same catalog layout as updategames export.
