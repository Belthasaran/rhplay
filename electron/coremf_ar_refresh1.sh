...
enode.sh ~/rhplay/jsutils/update_coremf.js ~/rhplay/electron/coremanifest.json --target "beta/RHPLAY/win64/portable"  --exe ~/release/0.1.23beta/RHTools-0.1.23-beta-portable.exe  --ardrive-drive-id "58677413-8a0c-4982-944d-4a1b40454039" --ardrive-folder-id  "eb87554f-6669-433b-9fb6-1204e018031c" 
