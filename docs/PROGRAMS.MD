...
- `--prepare` encrypts staged resources/screenshots with Fernet, writes reusable tokens to `jstools/resources/` and `jstools/screenshots/`, and deduplicates by file hash (resources) or hash/URL (screenshots).
