...
async function tryServerUrlsStub(options) {
  emitProgress(options, { phase: 'resolve', method: 7, message: 'Server URL retrieval not implemented (skipped)' });
...
async function runPatchblobMethods(ctx, patchblob, gameVersion, options) {
  ...
  const chain = [
    ...
    () => tryServerUrlsStub(options).then(() => null),
    async () => {
...
async function runPatchMethods(ctx, patchblob, gameVersion, options) {
  ...
  await tryMethod(7, () => tryServerUrlsStub(options));
